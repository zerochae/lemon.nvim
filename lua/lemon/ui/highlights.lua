...
function M.setup()
  local highlights = {
    ...
    LemonHoverKind = { link = "Function" },
    LemonHoverKindAlias = { link = "Special" },
    LemonHoverKindFunction = { link = "Function" },
    LemonHoverKindProperty = { link = "@property" },
    LemonHoverKindVariable = { link = "@variable" },
    LemonHoverKindType = { link = "Type" },
    LemonHoverKindEnum = { link = "Constant" },
    LemonHoverKindModule = { link = "@module" },
